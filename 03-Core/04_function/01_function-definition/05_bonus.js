/* 
    ...
    컨텍스트 실행시 최초의 스냅샷을 유지하고 있으며 컨텍스트를 생성할 떄 가장 먼저 정보를 담고
    이를 복사하며 LexicalEnvironment를 만들어 이후에 LexicalEnvironment를 주로 활용한다.
    ...
    현재 스코프 내외 식별자를 관리한다. 변수명과 해당 변수가 가리키는 값, 함수 선언 등을 기록한다.
